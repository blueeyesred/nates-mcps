...
export default function ServicePage({ params }: any) {
  ...
  const jsonLd = {
    ...
    offers: svc.basePrice
      ? { "@type": "Offer", priceCurrency: "USD", price: svc.basePrice }
      : undefined,
  };
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 max-w-3xl">
      ...
      <div className="mt-8 prose prose-neutral dark:prose-invert">
        ...
        <ul>
          <li>Friendly, respectful professionals who grew up here</li>
          <li>Detailed checklist tailored to your home or shop</li>
