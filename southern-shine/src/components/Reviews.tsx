      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="font-headline text-3xl sm:text-4xl font-bold">
            Neighbors who vouch for us
          </h2>
          <p className="mt-4 text-lg text-foreground/80">
            We built this company to serve the people who live and work alongside us. Here’s what
            East Tennessee families and small business owners say after we clean.
          </p>
        </div>
        ...
        <div className="mt-16 max-w-2xl mx-auto">
          <Accordion type="single" collapsible>
            <AccordionItem value="item-1">
              <AccordionTrigger className="text-xl font-headline">Leave a Review</AccordionTrigger>
              <AccordionContent>
                <form action={formAction} className="space-y-4 pt-4">
                  ...
                  <div className="space-y-2">
                    ...
                    {errors.review && (
                      <p className="text-sm text-destructive">{errors.review.message as string}</p>
                    )}
                  </div>
