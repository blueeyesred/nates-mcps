...
import { services, addons, carDetailingAddons } from "@/lib/data";
...
export default function Services() {
  ...
  const price = useMemo(() => {
    ...
    const sqftCharge = serviceType.includes("Clean")
      ? Math.max(0, sqft - 1000) * (selectedService.pricePerSqFt || 0)
      : 0;
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="font-headline text-3xl sm:text-4xl font-bold">
            Honest, hardworking services for East Tennessee families
          </h2>
          <p className="mt-4 text-lg text-foreground/80">
            Choose what you need, set your budget, and get transparent pricing from a crew of
            neighbors who clean like our reputation depends on it.
          </p>
        </div>
        ...
        <Card className="mt-12 max-w-4xl mx-auto shadow-lg">
          <CardHeader>
            ...
            <CardDescription>
              Answer a few questions and we’ll lock in a quote—no surprise fees, just neighborly
              service.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form action={formAction} className="space-y-8">
                ...
                >
                  {services.map((service) => (
                    <Label
                      ...
                      className="block cursor-pointer rounded-lg border bg-card p-4 has-[:checked]:bg-primary/10 has-[:checked]:border-primary transition-all"
                    >
              ...
              <div className="space-y-4">
                <Label className="text-lg font-semibold">
                  Step {serviceType.includes("Clean") ? 3 : 2}: Add-ons
                </Label>
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Controller
                    ...
                    control={control}
                    render={({ field }) => (
                      <Input placeholder="Address or Service Area" {...field} />
                    )}
                  />
                  {errors.address && (
              ...
              <input
                type="hidden"
                name="date"
                value={watch("date") ? new Date(watch("date") as Date).toISOString() : ""}
              />
